		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TestApp",
									"targetURL": "#comsapmytestapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmytestapp-display": {
								"semanticObject": "comsapmytestapp",
								"action": "display",
								"description": "A Fiori Test.",
								"title": "TestApp",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.mytestapp",
									"url": sap.ui.require.toUrl("com/sap/mytestapp")
								}
							}
						}
					}
